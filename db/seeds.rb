...
navbar_main_tab_list = [
  [ "PV Lab - Park10", "fa fa-tachometer", false, "/panels/report" ],
  [ "Mapuka - BLQ K", "fa fa-spinner", false, "/wind/report" ],
...
def create_general_tiles(dashboard)
  tiles_list = [
    ...
    [Page.find_by(title: "Mapuka - BLQ K", dashboard: dashboard), "Historic PF", "fa fa-repeat", "Historic PF", 2],
...
def create_general_rows(dashboard)
  rows_list = [
    [Page.find_by(title: "PV Lab - Park10", dashboard: dashboard), 3, 370, nil],
...
def create_general_panels(dashboard)
  panels_list = [
    ...
    [Row.find_by(order: 1, page: Page.find_by(title:"PV Lab - Park10", dashboard: dashboard)), "Solar Panels Location", nil, nil, 4, nil, nil, nil, nil ],
    [Row.find_by(order: 2, page: Page.find_by(title:"PV Lab - Park10", dashboard: dashboard)), "Power Report", "daily", nil, 12, nil, nil, nil, nil ],
    [Row.find_by(order: 3, page: Page.find_by(title:"PV Lab - Park10", dashboard: dashboard)), "Monthly Active Energy", "last year", nil, 12, nil, nil, nil, nil ],
    [Row.find_by(order: 4, page: Page.find_by(title:"PV Lab - Park10", dashboard: dashboard)), "PSH", "last 7 days", nil, 12, nil, nil, nil, nil ],
    ...
    [Row.find_by(order: 1, page: Page.find_by(title:"Mapuka - BLQ K", dashboard: dashboard)), "Wind Turbine Location", nil, nil, 4, nil, nil, nil, nil ],
    ...
    [Row.find_by(order: 4, page: Page.find_by(title:"Mapuka - BLQ K", dashboard: dashboard)), "Monthly Active Energy", "last year", nil, 12, nil, nil, nil, nil ],
    [Row.find_by(order: 5, page: Page.find_by(title:"Mapuka - BLQ K", dashboard: dashboard)), "Weather Report", nil, nil, 4, 1, nil, nil, nil ],
    [Row.find_by(order: 5, page: Page.find_by(title:"Mapuka - BLQ K", dashboard: dashboard)), "Wind", "last 3 days", nil, 8, nil, nil, nil, nil ],
    ...
    #[Row.find_by(order: 3, page: Page.find_by(title:"Data Charts", dashboard: dashboard)), "Panel Temperature", "last 7 days", nil, 6, nil, nil, nil, nil ],
    #[Row.find_by(order: 3, page: Page.find_by(title:"Data Charts", dashboard: dashboard)), "Panel PSH", "last 7 days", nil, 6, nil, nil, nil, nil ],
    #[Row.find_by(order: 4, page: Page.find_by(title:"Data Charts", dashboard: dashboard)), "Wind turbine vibration", "last 2 days", nil, 12, nil, nil, nil, nil ],
    #[Row.find_by(order: 5, page: Page.find_by(title:"Data Charts", dashboard: dashboard)), "Vibration FFT", "last 30 minutes", nil, 12, nil, nil, nil, nil ],
